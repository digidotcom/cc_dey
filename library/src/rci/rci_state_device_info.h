...
typedef enum {
	...
	CCAPI_STATE_DEVICE_INFORMATION_ERROR_BAD_COMMAND, /* PROTOCOL DEFINED */
	CCAPI_STATE_DEVICE_INFORMATION_ERROR_BAD_DESCRIPTOR,
	CCAPI_STATE_DEVICE_INFORMATION_ERROR_BAD_VALUE,
	CCAPI_STATE_DEVICE_INFORMATION_ERROR_INVALID_INDEX,
	CCAPI_STATE_DEVICE_INFORMATION_ERROR_INVALID_NAME,
	CCAPI_STATE_DEVICE_INFORMATION_ERROR_MISSING_NAME,
