...
typedef enum {
	...
	CCAPI_STATE_GPS_STATS_ERROR_BAD_COMMAND, /* PROTOCOL DEFINED */
	CCAPI_STATE_GPS_STATS_ERROR_BAD_DESCRIPTOR,
	CCAPI_STATE_GPS_STATS_ERROR_BAD_VALUE,
	CCAPI_STATE_GPS_STATS_ERROR_INVALID_INDEX,
	CCAPI_STATE_GPS_STATS_ERROR_INVALID_NAME,
	CCAPI_STATE_DGPS_STATS_ERROR_MISSING_NAME,
